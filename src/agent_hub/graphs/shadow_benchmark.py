...
def build_shadow_benchmark_graph(config:WorkspaceConfig):
 ...
 def load_reviewed_goldens(s): return {}
 ...
 graph=StateGraph(BenchmarkState); chain=[('load_scenarios',load_scenarios),('load_reviewed_goldens',load_reviewed_goldens),('run_context_analysis',run_context_analysis),('run_capability_analysis',run_capability_analysis),('score_evidence',score_evidence),('aggregate_metrics',aggregate_metrics),('evaluate_gate',evaluate_gate)]
